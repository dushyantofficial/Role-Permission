        ...
        <form id="submitterForm">
            ...
            <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="sd_country" value="{{old('sd_country')}}" name="sd_country"/>
                </div>
            </div>
        </form>
    </div>
        ...
        <form id="basic_information">
            <div class="form-group">
                <div class="form-row">
                    ...
                    <input type="text" id="id_title" value="{{old('id_title')}}" name="id_title"/>
                </div>
                <div class="form-row">
            ...
            <div class="backbutton" style="padding-inline: 30px;">
                ...
                <div class="submit-btn">
                    <button type="button" id="step_one" onclick="proceedToIdeaDetails()"
                            style="border-radius: 8px; font-size: 22px; display:flex; justify-content: center; align-items: center; gap:5px">
        ...
        ">
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_innovation" name="qs_innovation"
                              ...
                              style="overflow:hidden">{{old('qs_innovation')}}</textarea>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_feasibility" name="qs_feasibility"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_feasibility')}}</textarea>
                </div>
                <div>Impact:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                                ...
                                color: #000000;
                                line-height: 35.41px;">
                    The potential for the solution to generate positive environmental, social, and economic impact.
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_impact" name="qs_impact"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_impact')}}</textarea>
                </div>
                ...
                <div style="font-family: 'Open Sans';
                                ...
                                color: #000000;
                                line-height: 35.41px;">
                    The degree to which the solution aligns with sustainable principles and contributes to a circular
                    economy.
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_sustainability" name="qs_sustainability"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_sustainability')}}</textarea>
                </div>
                <div>Scalability:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                                ...
                                color: #000000;
                                line-height: 35.41px;">
                    The potential for the solution to be implemented on a large scale and have a significant impact on
                    the clean technology industry
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_scalability" name="qs_scalability"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_scalability')}}</textarea>
                </div>
                <div>Disruption:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                                ...
                                color: #000000;
                                line-height: 35.41px;">
                    The extent to which the proposed solution challenges the status quo and accelerates the clean
                    technology transformation through a disruptive approach
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_disruption" name="qs_disruption"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_disruption')}}</textarea>
                </div>
                <div>Potential:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                                ...
                                color: #000000;
                                line-height: 35.41px;">
                    The potential for the startup to attract investment or funding, based on the strength and experience
                    of its team, business model, technology, growth prospects, and overall fundability
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_potential" name="qs_potential"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_potential')}}</textarea>
                </div>
                <div class="backbutton">
                    ...
                    <div class="submit-btn">
                        <button type="button" id="step_two" onclick="proceedToEvaluationDetails()"
                                style="border-radius: 8px; font-size: 22px; display:flex; justify-content: center; align-items: center; gap:5px">
...
<section class="form-section-aec" style="display: none;">
    ...
    <div class="form-sectioneva">
      ...
      ">
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_ease_of_implementation"
                              name="qs_ease_of_implementation" onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_ease_of_implementation')}}</textarea>
                </div>
                <div>Time to implement:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                              font-weight: 600;
                              color: #000000;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_time_to_implement" name="qs_time_to_implement"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_time_to_implement')}}</textarea>
                </div>
                <div>Desirability & Usability:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                              font-weight: 600;
                              color: #000000;
                              line-height: 35.41px;">
                    How likely is the internal customer (of this idea) to use and implement the solution?
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_desirability_usability"
                              name="qs_desirability_usability" onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_desirability_usability')}}</textarea>
                </div>
                <div>Practicality:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                              font-weight: 600;
                              color: #000000;
                              line-height: 35.41px;">
                    Is the idea practical in terms of development?
                </div>
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_practicality" name="qs_practicality"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_practicality')}}</textarea>
                </div>
                <div>Disruption:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="disruption" name="disruption"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('disruption')}}</textarea>
                </div>
                <div>Sustainability:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_sustainability_second"
                              name="qs_sustainability_second" onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_sustainability_second')}}</textarea>
                </div>
                <div>IP Potential:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                              font-weight: 600;
                              color: #000000;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_ip_potential" name="qs_ip_potential"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden">{{old('qs_ip_potential')}}</textarea>
                </div>
...
<script>
    ...
    //         const formData = new FormData(submitterForm);
    //
    //         // Get textarea values separately
    //         const textareas = document.getElementsByTagName("textarea");
    //         for (const textarea of textareas) {
    //             formData.append(textarea.name, textarea.value);
    //         }
    //
    //         // Get checkbox values separately
    //         const checkboxes = document.querySelectorAll('input[type="checkbox"]:checked');
    //         for (const checkbox of checkboxes) {
    //             formData.append(checkbox.name, checkbox.value);
    //         }
    //
    //         // Get file values separately (input type="file" supports multiple files)
...
<script>
    ...
    function submitForm() {
        ...
        //Step Two
        var qs_innovation = $('#qs_innovation').val();
        var qs_feasibility = $('#qs_feasibility').val();
        var qs_impact = $('#qs_impact').val();
        var qs_sustainability = $('#qs_sustainability').val();
        var qs_scalability = $('#qs_scalability').val();
        var qs_disruption = $('#qs_disruption').val();
        var qs_potential = $('#qs_potential').val();

        //Step Three
        var qs_ease_of_implementation = $('#qs_ease_of_implementation').val();
        var qs_time_to_implement = $('#qs_time_to_implement').val();
        var qs_desirability_usability = $('#qs_desirability_usability').val();
        var qs_practicality = $('#qs_practicality').val();
        var qs_sustainability_second = $('#qs_sustainability_second').val();
        var disruption = $('#disruption').val();
        var qs_ip_potential = $('#qs_ip_potential').val();
        ...
        //Step Two
        formData.append('qs_innovation', qs_innovation);
        formData.append('qs_feasibility', qs_feasibility);
        formData.append('qs_impact', qs_impact);
        formData.append('qs_sustainability', qs_sustainability);
        formData.append('qs_scalability', qs_scalability);
        formData.append('qs_disruption', qs_disruption);
        formData.append('qs_potential', qs_potential);

        //Step Three
        formData.append('qs_ease_of_implementation', qs_ease_of_implementation);
        formData.append('qs_time_to_implement', qs_time_to_implement);
        formData.append('qs_desirability_usability', qs_desirability_usability);
        formData.append('qs_practicality', qs_practicality);
        formData.append('qs_sustainability_second', qs_sustainability_second);
        formData.append('disruption', disruption);
        formData.append('qs_ip_potential', qs_ip_potential);
        ...
        for (var ii = 0; ii < files.length; ii++) {
            formData.append("attachment[]", files[ii]);
        }
        // if (validate==true) {
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.21/role-permissions-blog/public/api/add_register_page',
            data: formData,
