...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <div>
                <h1><i class="fa fa-th-list"></i>Show All Refund Payment History</h1>
            </div>
                    ...
                    <div class="tile-body sortableTable__container table-responsive" id="my_report">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tr>
                                ...
                                <th>Entity</th>
                                <th>Status</th>
                                <th>Speed Processed</th>
                                <th>Speed Requested</th>
                                <th>Payment Date</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($refund_payments_historys as $key => $payment)
                                <tr>
                                    ...
                                    <td>{{ $payment->speed_processed }}</td>
                                    <td>{{ $payment->speed_requested }}</td>
                                    <td>
                                        @php
            ...
            $(document).on('click', '.delete-payment', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: '{{ route('refund-payment-history-delete')}}',
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: id,
                            },
