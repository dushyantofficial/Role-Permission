...
@section('content')
    ...
    <main class="app-content {{user_theme_get()}}">
        <div class="app-title">
            ...
            <div>
                <h1><i class="fa fa-th-list"></i>Show All Work Experiences</h1>
            </div>
 ...
 + Add
                ...
                <div class="tile">
                    <div class="tile-body sortableTable__container table-responsive" id="my_report">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                            @foreach ($work_experiences as $key => $work_experience)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>
                                        @if(isset($work_experience->resume_name))
                                            {{ $work_experience->resume_name->name }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    <td>{{ $work_experience->destination }}</td>
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="statuss"
                                                   ...
                                                   id="statusToggle" {{ $work_experience->status === 'active' ? 'checked' : '' }}>
                                    ...
                                    <td>
                                        <button type="button"
                                                ...
                                                data-disable_date="{{$work_experience->id}}"
                                                data-bs-target="#edit_work_experiences{{$work_experience->id}}">
                                            <i class="fa fa-edit"></i>
                                        </button>

                                        <button
                                            class="btn btn-sm btn-shadow btn-outline-danger btn-hover-shine delete-experience"
                                            data-delete-id="{{ $work_experience->id }}">
                                            <i class="fa fa-trash" aria-hidden="true"></i></button>
                                        {{--                                        {!! Form::open(['method' => 'DELETE','route' => ['work_experiences.destroy', $work_experience->id],'style'=>'display:inline','onclick' => "return confirm('Are you sure?')"]) !!}--}}
                                        {{--                                        {!! Form::submit('Delete', ['class' => 'btn btn-outline-danger']) !!}--}}
                                        {{--                                        {!! Form::close() !!}--}}
                                    </td>
                                </tr>

                                <!-- Edit work_experiences Modal -->
                                <div class="modal fade" id="edit_work_experiences{{$work_experience->id}}"
                                     data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                     aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" style="max-width: 50%;">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Work Experiences</h5>
        ...
        ">
                                            ...
                                            <div class="modal-body">
                                                <form id="edit_form_{{ $work_experience->id }}"
                                                      action="{{route('work_experiences.update',$work_experience->id)}}"
                                                      method="post"
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="resume_id" id="">
                                                                    ...
                                                                    @foreach($resumes as $resume)
                                                                        <option
                                                                            value="{{$resume->id}}" @if(isset($work_experience)) {{$work_experience->resume_id == $resume->id  ? 'selected' : ''}} @endif>{{$resume->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="destination" id="">
                                                                    ...
                                                                    @foreach(config('constants.DESTINATION') as $key => $destination)
                                                                        <option
                                                                            value="{{$destination}}" @if(isset($work_experience)) {{$work_experience->destination == $destination  ? 'selected' : ''}} @endif>{{$key}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="month"
                                                                       ...
                                                                       value="{{$work_experience->start_date}}" max=""
                                                                       name="start_date">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="month"
                                                                       ...
                                                                       id="end_date_{{$work_experience->id}}"
                                                                       value="{{$work_experience->end_date}}"
                                                                       min="" name="end_date">

                                                                <input type="checkbox"
                                                                       class="checkbox-class check"
                                                                       data-enddate="end_date_{{$work_experience->id}}"
                                                                       id="check_{{$work_experience->id}}" value="1"
                                                                       name="check" @if(isset($work_experience)) {{$work_experience->check == 1  ? 'checked' : ''}} @endif>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="description" id="" >{{$work_experience->description}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-shadow btn-outline-info btn-hover-shine update-btn"
                                                                data-resume-id="{{ $work_experience->id }}">Update
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
        ...
        ">
                    ...
                    <div class="modal-body">
                        <form id="add_form" action="{{route('work_experiences.store')}}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-6">
        ...
        $(document).ready(function () {
            $('.update-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    success: function (data) {
                        $('#edit_work_experiences' + resumeId).modal('hide');
    ...
    <script>
        $('.statuss').change(function () {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('work_experiencesStatus') }}',
            ...
            $(document).on('click', '.delete-experience', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: '{{ route('work_experiences.destroy', ['work_experience' => 'id']) }}' + id,
                            data: {
                                _token: '{{ csrf_token() }}',
                            },
