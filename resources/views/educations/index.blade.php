...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <div>
                <h1><i class="fa fa-th-list"></i>Show All Educations</h1>
            </div>
 ...
 + Add
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            @foreach ($educations as $key => $education)
                                @php
                                    ...
                                    $before_month = date('Y-m', strtotime("$current_year-$current_month"));
                                @endphp
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>
                                        @if(isset($education->resume_name))
                                            {{ $education->resume_name->name }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="statuss"
                                                   ...
                                                   id="statusToggle" {{ $education->status === 'active' ? 'checked' : '' }}>
                                    ...
                                    <td>
                                        <button type="button"
                                                ...
                                                data-disable_date="{{$education->id}}"
                                                data-bs-target="#edit_educations{{$education->id}}">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button
                                            class="btn btn-sm btn-shadow btn-outline-danger btn-hover-shine delete-education"
                                            data-delete-id="{{ $education->id }}">
                                            <i class="fa fa-trash" aria-hidden="true"></i></button>
                                        {{--                                        {!! Form::open(['method' => 'DELETE','route' => ['educations.destroy', $education->id],'style'=>'display:inline','onclick' => "return confirm('Are you sure?')"]) !!}--}}
                                ...
                                <div class="modal fade" id="edit_educations{{$education->id}}"
                                     data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                     aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" style="max-width: 50%;">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Educations</h5>
        ...
        ">
                                            ...
                                            <div class="modal-body">
                                                <form id="edit_form_{{ $education->id }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="resume_id" id="">
                                                                    ...
                                                                    @foreach($resumes as $resume)
                                                                        <option
                                                                            value="{{$resume->id}}" @if(isset($education)) {{$education->resume_id == $resume->id  ? 'selected' : ''}} @endif>{{$resume->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="checkbox"
                                                                       ...
                                                                       data-enddate="end_date_{{$education->id}}"
                                                                       id="check_{{$education->id}}" value="1"
                                                                       name="check" @if(isset($education)) {{$education->check == 1  ? 'checked' : ''}} @endif>
        ...
        $(document).ready(function () {
            $('.update-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    success: function (data) {
                        $('#edit_educations' + resumeId).modal('hide');
            ...
            $(document).on('click', '.delete-education', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: '{{ route('educations.destroy', ['education' => 'id']) }}' + id,
                            data: {
                                _token: '{{ csrf_token() }}',
                            },
