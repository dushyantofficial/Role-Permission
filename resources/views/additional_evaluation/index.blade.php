...
<div class="container">
    ...
    <div class="row mb-3">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end col-4">
            <a href="{{route('additional-evaluation-criteria-create')}}" ><button class="btn btn-primary me-md-2">Add New Question</button></a>
        </div>
    </div>
    <table class="table table-fluid" id="myTable">
        ...
        <tr>
            <td>3</td>
            <td>What is your mother name?</td>
            <td>Yes</td>
            <td>Radio</td>
            <td>
                <button class="btn btn-info">Edit</button>
