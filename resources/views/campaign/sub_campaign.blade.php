...
<div class="container">
    ...
    <table class="table table-fluid" id="myTable">
        ...
        @foreach($campaign_sub_ideas_indexs as $campaign_sub_ideas_index)
            <tr>
                <td>{{$loop->iteration}}</td>
                <td>{{$campaign_sub_ideas_index->question_name->question}}</td>
                <td>{{$campaign_sub_ideas_index->label_name}}</td>
                <td>{{$campaign_sub_ideas_index->label_value}}</td>
                <td>
