        ...
        <form id="basic_information" class="validated">
            ...
            <div class="media" style="display: flex; justify-content: space-evenly;">
                <div class="checkbox-mobile">
                    ...
                    <div class="pcategory">
                        <input type="checkbox" id="product" name="id_category" value="product"
                               onchange="toggleCheckboxes1('product')" required>
                ...
                <div class="checkbox-mobile">
                    ...
                    <div class="pcategory">
                        <input type="checkbox" id="concept" name="id_stage_of_idea" value="concept"
                               onchange="toggleCheckboxes2('concept')" required>
                    ...
                    <div class="pcategory">
                        <input type="checkbox" id="development" name="id_stage_of_idea" value="development"
                               onchange="toggleCheckboxes2('development')" required>
                ...
                <div class="checkbox-mobile">
                    ...
                    <div class="pcategory">
                        <input type="checkbox" id="energy" name="id_sector_tech_area[]" value="energy" required>
            ...
            <div class="ocategory">
                <input type="checkbox" id="process" name="id_idea_objective" value="process"
                       onchange="toggleCheckboxes4('process')" required>
        ...
        ">
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_feasibility" name="qs_feasibility"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_feasibility')}}</textarea>
                </div>
                <div>Impact:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_impact" name="qs_impact"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_impact')}}</textarea>
                </div>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_sustainability" name="qs_sustainability"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_sustainability')}}</textarea>
                </div>
                <div>Scalability:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_scalability" name="qs_scalability"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_scalability')}}</textarea>
                </div>
                <div>Disruption:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_disruption" name="qs_disruption"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_disruption')}}</textarea>
                </div>
                <div>Potential:</div>
                <div style="font-family: 'Open Sans';
                                font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_potential" name="qs_potential"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_potential')}}</textarea>
                </div>
      ...
      ">
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_ease_of_implementation"
                              ...
                              style="overflow:hidden" required>{{old('qs_ease_of_implementation')}}</textarea>
                </div>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_time_to_implement" name="qs_time_to_implement"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_time_to_implement')}}</textarea>
                </div>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_desirability_usability"
                              ...
                              style="overflow:hidden" required>{{old('qs_desirability_usability')}}</textarea>
                </div>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_practicality" name="qs_practicality"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_practicality')}}</textarea>
                </div>
                <div>Disruption:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="disruption" name="disruption"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('disruption')}}</textarea>
                </div>
                <div>Sustainability:</div>
                <div style="font-family: 'Open Sans';
                              font-size: 18px;
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_sustainability_second"
                              ...
                              style="overflow:hidden" required>{{old('qs_sustainability_second')}}</textarea>
                </div>
                ...
                <div class="container">
                    <textarea placeholder="Enter your text here" id="qs_ip_potential" name="qs_ip_potential"
                              onkeyup="textAreaAdjust(this)"
                              style="overflow:hidden" required>{{old('qs_ip_potential')}}</textarea>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        emailInput.addEventListener('blur', function () {
            ...
            axios.get('http://192.168.1.8/role-permissions-blog/public/api/check-email', {
                params: {
                    email: email
                }
            })
...
<script>
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.8/role-permissions-blog/public/api/test_add_register_page',
            data: formData,
