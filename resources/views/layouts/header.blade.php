<header class="app-header {{user_theme_get()}}">
    ...
    <form id="backup_form" action="{{route('backup-run')}}" method="GET">
        @csrf
        <button type="button" style="margin: 9px !important;"
    ...
    <form action="#">
        <button id="toggleThemeBtn" style="margin: 9px !important;"
                class="btn btn-sm btn-shadow btn-outline-light btn-hover-shine toggleThemeBtn">
        ...
        <button class="btn btn-sm btn-shadow btn-outline-warning btn-hover-shine zoom-button" id="zoomOut"><i
                class="fa fa-search-minus" aria-hidden="true"></i></button>
        <button class="btn btn-sm btn-shadow btn-outline-danger btn-hover-shine zoom-button" id="resetZoom"><i
