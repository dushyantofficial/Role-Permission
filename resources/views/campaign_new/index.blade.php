...
<div class="container">
    ...
    <table class="table table-fluid" id="myTable">
        ...
        @foreach($campaign_news as $campaign_new)
            <tr>
                <td>{{$loop->iteration}}</td>
                <td>{{$campaign_new->campaign_title}}</td>
                <td>
                    <i class="fa-solid fa-copy" data-value="{{route('index-page')}}?id={{encrypt($campaign_new->id)}}"
                       onclick="copyToClipboard(this)">
                    </i>
                </td>
                <td>
                    <a href="{{route('campaign-idea-edit',$campaign_new->id)}}" class="btn btn-info"><i
                            class="fas fa-edit"></i></a>
                    <a href="{{route('campaign-idea-delete',$campaign_new->id)}}"
...
<script>
    function copyToClipboard(iconElement) {
        var dataValue = iconElement.getAttribute('data-value');
        ...
        //  iconElement.textContent = 'Copied!';
        setTimeout(function () {
        ...
        }, 1000); // 1 seconds (30,000 milliseconds)


        // console.log('Copied data-value:', dataValue);
    }
</script>
<script>
